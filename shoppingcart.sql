...
-- Volcando datos para la tabla shoppingcart.addresses: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla shoppingcart.customers: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla shoppingcart.products: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `products` DISABLE KEYS */;
INSERT INTO `products` (`id`, `title`, `slug`, `description`, `price`, `image`, `stock`, `created_at`, `updated_at`) VALUES
	(1, 'coffee mug', 'coffee-mug', 'a simple mug', 5.7, 'https://placeholdit.imgix.net/~text?txtsize=33&txt=350%C3%97150&w=350&h=150', 10, '2017-03-01 16:05:00', '2017-03-01 16:05:01'),
